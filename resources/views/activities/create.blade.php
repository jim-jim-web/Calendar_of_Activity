            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8">
                ...
                <form action="{{ route('activities.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="title" class="w-full bg-white border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl py-2.5 px-4 text-slate-800 text-sm placeholder-slate-400 transition" placeholder="e.g., Advanced Microeconomics Lecture" required>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-5 mb-5">
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <input type="datetime-local" name="activity_date" class="w-full bg-white border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl py-2.5 px-4 text-slate-800 text-sm transition" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="3" class="w-full bg-white border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-xl py-2.5 px-4 text-slate-800 text-sm placeholder-slate-400 transition" placeholder="Briefly describe the topics covered or preparation required..." required></textarea>
                    </div>
